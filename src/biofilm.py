...
class Biofilm(object):
    ...
    def spawn(self, startNum):
        for _ in range(startNum):
            ...
            bac = bacterium(pos, width, length, (0,0,0), [random.random()*3.14, (0.5-random.random()*3.14)], 0, True, False)
    ...
    def evolve(self,   gr_factor, gr_pr_i, gr_factor_inv, gr_d_factor, mortility_rate, motion_activation, motion_deactivation,   frameDim, combined_friction, splitting_rate, dt):
        for Bacterium in self.bacteria:                               
            Bacterium.grow(gr_factor, gr_pr_i, gr_factor_inv, gr_d_factor, mortility_rate)      
            ...
            for _Bacterium in self.bacteria:
                if((Bacterium.pos[0] == _Bacterium.pos[0]) and (Bacterium.pos[1] == _Bacterium.pos[1]) and (Bacterium.pos[2] == _Bacterium.pos[2])):
                    True
                else:
