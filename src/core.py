...
def coreLoop(biofilm, out, txt):  
    ...
    while(cv2.getWindowProperty("frame", 0) >= 0):  
        ...
        biofilm.evolve(gr_factor, gr_pr_i, gr_factor_inv, gr_d_factor, mortility_rate, motion_activation, motion_deactivation,   frameDimBacteria, combined_friction, splitting_rate, dt)
